...
function Register() {
  ...
  function mapFirebaseError(errorCode) {
    switch (errorCode) {
      ...
      case "auth/weak-password":
        return "The password is too weak. Please choose a stronger password that meets minimum length and complexity requirements.";
      case "auth/wrong-password":
        return "Incorrect email or password. Please double-check and try again."; // Separate messages could be used if needed
      case "auth/network-request-failed":
        return "A network error occurred. Please check your internet connection and try again.";
      case "auth/user-not-found":
        return "The email address you entered does not correspond to an existing account.";
      case "auth/user-disabled":
        return "This account has been disabled. Please contact support for assistance.";
      case "auth/too-many-requests":
        return "Too many sign-in attempts have been made in a short period. Please wait a few minutes and try again. If you believe this is a mistake, contact support.";
      case "auth/unverified-email":
        return "The email address associated with this account hasn't been verified yet. Please check your email for a verification link.";
      case "auth/operation-not-allowed":
        return "This operation is not allowed for your account. Please contact support if you believe this is incorrect.";
      case "auth/missing-password":
        return "Please enter your password to proceed.";
      default:
        return "An unknown error occurred. Please try again later. If the issue persists, contact support.";
    }
  }
  ...
  return (
    <div className="flex bg-[#F2F7FF] fade py-20">
      <div className=" flex basis-1/2 justify-center items-center">
        ...
        >
          ...
          />
          <path
            id="uuid-31bdf68e-d938-48b7-86ad-7ba8e8b265d3-91-89-41-39"
          ...
          />
          <path
            id="uuid-0d1d7be6-7e67-43a2-9b15-a4bbed67d7bc-92-90-42-40"
      ...
      <div className="basis-1/2  justify-center items-center">
        <div className="flex flex-col items-center m-16 p-16 bg-white rounded-3xl">
          <div className="text-3xl font-semibold mb-6">Register</div>
          {errorMessage && (
            <div
              role="alert"
              className="alert alert-error error-message mb-6 text-black "
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <input
            className="border-2 w-full py-3 pl-6 mb-4 rounded-xl border-gray-200 px-4 text-gray-700 focus:outline-none focus:bg-white focus:border-blue-500"
          ...
          <div className="flex w-full gap-4 justify-between mb-4">
            <input
              className="border-2 w-1/3 py-3 pl-6 rounded-xl border-gray-200 px-4 text-gray-700 focus:outline-none focus:bg-white focus:border-blue-500"
              type="number"
              placeholder="Age"
            ></input>
            <select className="border-2 w-2/3 py-3 pl-6 rounded-xl">
          ...
          <div className="flex gap-4 mb-4">
            <input
              className="border-2 w-full py-3 pl-6 rounded-xl border-gray-200 px-4 text-gray-700 focus:outline-none focus:bg-white focus:border-blue-500"
              type="number"
              placeholder="Height"
            ></input>
            <input
          ...
          <Link
            className="py-3 px-10 rounded-2xl bg-gradient-to-r from-blue-500 to-indigo-500 text-white
