...
function Login() {
  ...
  function mapFirebaseError(errorCode) {
    switch (errorCode) {
      ...
      case "auth/wrong-password":
        return "Incorrect email or password. Please double-check and try again."; // Consider separate messages for email/password errors if needed
      ...
      case "auth/captcha-check-failed":
        return "The reCAPTCHA challenge was not completed successfully. Please try again."; // If using reCAPTCHA
      case "auth/invalid-verification-code":
        return "The verification code you entered is incorrect. Please check your email or SMS for the correct code."; // If using email/phone verification
      case "auth/invalid-credential":
        return "There was an error with your sign-in credentials. Please try again."; // Generic message for invalid credentials
      default:
  ...
  return (
    <div className="flex bg-[#F2F7FF] py-20 fade ">
      <div className=" flex basis-1/2 justify-center items-center">
        ...
        >
          <defs>
            <linearGradient
              id="60552b3d-cc23-4bcb-bcbd-c0b00e2743d7-52"
              x1="454.54"
              y1="832.71"
              x2="454.54"
              y2="147.53"
          ...
          <path
            ...
            opacity="0.1"
          />
          <ellipse cx="286.68" cy="761.68" rx="227" ry="37.21" fill="#418cff" />
          <path
            ...
            transform="translate(-86.32 -50.56)"
            fill="url(#60552b3d-cc23-4bcb-bcbd-c0b00e2743d7-52)"
          />
          <path
      ...
      <div className="flex basis-1/2 justify-center items-center">
        <div className="flex">
          <div className="flex flex-col items-center m-7 p-40 bg-white rounded-3xl ">
            <div className="text-3xl font-semibold mb-6">Login</div>
            {errorMessage && (
              <div role="alert" className="alert alert-error error-message mb-6 text-black "><svg xmlns="http://www.w3.org/2000/svg" className="stroke-current shrink-0 h-6 w-6" fill="none" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>{errorMessage}</div>
            )}
            <input
              className="border-2 w-full py-3 pl-6 mb-6 rounded-xl border-gray-200 px-4 text-gray-700 focus:outline-none focus:bg-white focus:border-blue-500"
              placeholder="Enter Email"
              onChange={(event) => setEmail(event.target.value)}
            ></input>
            <input
              className="border-2 w-full py-3 pl-6 px-40 rounded-xl border-gray-200 px-4 text-gray-700 focus:outline-none focus:bg-white focus:border-blue-500"
              type="password"
